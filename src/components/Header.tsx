export function Header() {
  return (
    <header className="relative overflow-hidden text-center py-10 px-4 mb-2">
      ...
      <div className="pointer-events-none absolute inset-x-0 top-28 h-24 bg-gradient-to-b from-transparent to-[rgba(243,250,238,0.95)]" />
      ...
      <div className="relative animate-rise">
        ...
        <p className="mt-1 text-lg md:text-xl font-bold text-[#eef8e6]">
          情報まとめ
        </p>
        <p className="mt-4 text-sm md:text-base text-[#d9edd0] max-w-lg mx-auto leading-relaxed">
